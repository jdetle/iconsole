...
<html lang="en">
<head>
    <title>Code coverage report for src/observable/FromEventObservable.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/observable/FromEventObservable.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/observable/</a> &#187; FromEventObservable.ts</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        subscriber.error(errorObject.e);</span>
      } else {
