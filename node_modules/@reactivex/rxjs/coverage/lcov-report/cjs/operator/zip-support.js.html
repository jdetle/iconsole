...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operator/zip-support.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operator/zip-support.js</span></h1>
    <h2>
        Statements: <span class="metric">96.58% <small>(141 / 146)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">84.44% <small>(38 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">93.55% <small>(29 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.48% <small>(137 / 142)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operator/</a> &#187; zip-support.js</div>
</div>
<div class="body">
...
var ZipSubscriber = (function (_super) {
    ...
    function ZipSubscriber(destination, project, values) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (values === void 0) { values = Object.create(null); }
...
var StaticArrayIterator = (function () {
    ...
    StaticArrayIterator.prototype[SymbolShim_1.SymbolShim.iterator] = <span class="fstat-no" title="function not covered" >function () {</span>
...
var ZipBufferIterator = (function (_super) {
    ...
    ZipBufferIterator.prototype[SymbolShim_1.SymbolShim.iterator] = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        return this;</span>
    };
...
//# sourceMappingURL=zip-support.js.map</pre></td></tr>
</table></pre>
