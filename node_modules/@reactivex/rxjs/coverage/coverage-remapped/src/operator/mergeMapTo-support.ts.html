...
<html lang="en">
<head>
    <title>Code coverage report for src/operator/mergeMapTo-support.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/operator/mergeMapTo-support.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/operator/</a> &#187; mergeMapTo-support.ts</div>
</div>
<div class="body">
...
export class MergeMapToOperator&lt;T, R, R2&gt; implements Operator&lt;T, R&gt; {
  constructor(private ish: any,
              ...
              <span class="missing-if-branch" title="if path not taken" >I</span>private concurrent: number = Number.POSITIVE_INFINITY) {
    }
&nbsp;
