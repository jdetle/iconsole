...
<html lang="en">
<head>
    <title>Code coverage report for src/observable/FromEventPatternObservable.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/observable/FromEventPatternObservable.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/observable/</a> &#187; FromEventPatternObservable.ts</div>
</div>
<div class="body">
...
&nbsp;
    ...
    } : <span class="fstat-no" title="function not covered" >function(e: any)</span> { <span class="cstat-no" title="statement not covered" >subscriber.next(e); </span>};
&nbsp;
