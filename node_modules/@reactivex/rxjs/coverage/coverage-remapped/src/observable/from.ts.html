...
<html lang="en">
<head>
    <title>Code coverage report for src/observable/from.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/observable/from.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/observable/</a> &#187; from.ts</div>
</div>
<div class="body">
...
&nbsp;
  static create&lt;T&gt;(ish: any, scheduler: Scheduler = null): Observable&lt;T&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ish != null) {
...
&nbsp;
    throw new TypeError((ish !== null &amp;&amp; typeof ish || <span class="branch-2 cbranch-no" title="branch not covered" >ish)</span> + ' is not observable');
  }
&nbsp;
