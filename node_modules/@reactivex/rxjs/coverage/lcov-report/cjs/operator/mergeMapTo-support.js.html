...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operator/mergeMapTo-support.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operator/mergeMapTo-support.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operator/</a> &#187; mergeMapTo-support.js</div>
</div>
<div class="body">
...
var MergeMapToOperator = (function () {
    function MergeMapToOperator(ish, resultSelector, concurrent) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (concurrent === void 0) { <span class="cstat-no" title="statement not covered" >concurrent = Number.POSITIVE_INFINITY; </span>}
        this.ish = ish;
...
//# sourceMappingURL=mergeMapTo-support.js.map</pre></td></tr>
</table></pre>
